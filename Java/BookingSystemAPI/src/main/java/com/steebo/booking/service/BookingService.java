...
public class BookingService {
	...
	public List<Booking> findBookingsByContactNumber(String contactNumber) {
		return bookingRepository.findByGuestContactNumberContaining(contactNumber);
	}

	public List<Booking> findBookingsByRoomNumber(String roomNumber) {
		return bookingRepository.findByRoomNumberContaining(roomNumber);
	}
